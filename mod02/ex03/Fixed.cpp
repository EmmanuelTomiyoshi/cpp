...
{
	if (this->_fixedPoint < lt._fixedPoint)
		return true;
	return false;
}
...
{
	if (this->_fixedPoint > mt._fixedPoint)
		return true;
	return false;
}
...
{
	if (this->_fixedPoint >= met._fixedPoint)
		return true;
	return false;
}
...
{
	if (this->_fixedPoint >= let._fixedPoint)
		return true;
	return false;
}
...
{
	if (this->_fixedPoint == eq._fixedPoint)
		return true;
	return false;
}
...
{
	if (this->_fixedPoint == diff._fixedPoint)
		return true;
	return false;
}
